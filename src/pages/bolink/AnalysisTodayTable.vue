		...
		data(){
			return {
				...
				tableitems:[
					...
					{hasSubs:false,label:'',subs:[
						//{label:'现金',prop:'park_cash',width:"200",type:'str',editable:true,searchable:true,addable:true,unsortable:true,align:'center'},
            			{label:'交易车场数',prop:'park_counts',width:"200",type:'str',editable:true,searchable:true,addable:true,unsortable:true,align:'center'},
					]},
					{hasSubs:false,label:'',subs:[
						//{label:'现金',prop:'cash_count',width:"200",type:'str',editable:true,searchable:true,addable:true,unsortable:true,align:'center'},
                        {label:'交易笔数',prop:'trade_counts',width:"200",type:'str',editable:true,searchable:true,addable:true,unsortable:true,align:'center'},
					]},		
					{hasSubs:false,label:'',subs:[
						...
						// 	}
						// },
						{label:'交易金额',prop:'money_sum',width:"200",type:'str',editable:true,searchable:true,addable:true,unsortable:true,align:'center',
							format:function(row){
